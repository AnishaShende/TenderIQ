...
const SearchProjects = () => {
  ...
  return (
    ...
    <div className="flex flex-col w-full ml-0 py-1">
      ...
      <div className="absolute top-20 right-2 text-xs font-bold">
        ...
        {/* <div id="google_translate_element" class=" absolute top-20 inline-block p-2 border border-gray-300 rounded-md bg-white shadow-sm text-sm"></div> */}
